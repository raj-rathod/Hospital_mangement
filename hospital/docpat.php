...
<body>
  ...
  <section class="hero">
    <div class="container text-center">
      ...
      <div class="col-md-12">
        ...
        <a class="btn btn-full" href="registration/medicine.php">Medicine </a>
  ...
  <div class="container">
    <div class="card" >
        <h3 class="text-center">Todays Patient List</h3>
      ...
      <div class="card-body bg-dark">
        <?php
          if (isset($_SESSION['did'])) {
             ...
             $date=date("Y-m-d");
             $sql="SELECT * FROM patient WHERE dname='$dname'AND regdate='$date' AND showp='0'";
          ...
          <div class='col-md-2'>
            <h3 class='text-center text-white'><div class='btn btn-outline-danger del' pid='$pid' >Delete</div></h3>
          </div>
        </div>";
             }
          }
